			...
			<div class="right-nav">
					<ul>
							<li><img src="images/home.png"></li>
								...
								<li>></li>
								<li><a href="NoticeCL?flag=Update">修改公告</a></li>
						</ul>
			</div>
				 ...
				 <table  width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D7EDFB">
				  ...
				  <tr>
				    ...
				    <td height="400" bgcolor="#D7EDFB">
				    	<form name="form1" action="NoticeCL?flag=UpdateCL"  id="notice" method="post">
						<textarea style="height:400px;width:480px;background:#D7EDFB;" form="notice" name="content">
						<%
						String contentC="";
						NoticeBean content=(NoticeBean)request.getAttribute("content");
							if(content.getContent()!=null)
								contentC=content.getContent();
