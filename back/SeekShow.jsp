			...
			<div class="right-nav">
					<ul>
							<li><img src="images/home.png"></li>
								...
								<li>></li>
								<li><a href="UsersCl?flag=seek&pageNow=1">用户信息</a> </li>
				 ...
				 <center>  
						 <h1>用户信息</h1><hr>
							  <%
							    ...
							    //要显示的用后信息从request
							    String flagCx=request.getParameter("flagCx");
								String selectCx=request.getParameter("select");	
							  ...
							  <%
							  if(pageNow!=1){
							     out.println("<a href=UsersCl?flag=seek&pageNow="+(pageNow-1)+"&flagCx="+flagCx+"&select="+selectCx+" >上一页</a>"); 
							  }
							  String s_pageCount=(String)request.getAttribute("pageCount");
							  int pageCount=Integer.parseInt(s_pageCount);
							  
							  for(int i=1;i<=pageCount;i++){
							   out.println("<a href=UsersCl?flag=seek&pageNow="+i+"&flagCx="+flagCx+"&select="+selectCx+" >["+i+"]</a>");
							  }
							  if(pageNow!=pageCount&&pageCount!=0){
							     out.println("<a href=UsersCl?flag=seek&pageNow="+(pageNow+1)+"&flagCx="+flagCx+"&select="+selectCx+" >下一页</a>"); 
							  }
							  %><br>
							  <a href="Seek.jsp">继续查找</a></h3>
				 </center>
			</div>
		</div>
